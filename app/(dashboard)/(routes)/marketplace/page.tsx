...
export default function MarketplacePage() {
  ...
  useEffect(() => {
    // as useEffect doesn't let us make it an async function so we need to declare an asnyc function inside it.
  ...
  return (
    <div>
      ...
      {!hasMore && (
        <div className=" flex items-center justify-center p-6 mt-12 rounded-lg mb-10 text-center md:text-xl bg-orange-900/10 text-orange-900  dark:bg-orange-500/10 dark:text-white">
