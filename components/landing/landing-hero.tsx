...
export default function LandingHero() {
  ...
  return (
    <div
      className="min-h-screen w-full relative flex flex-col items-center justify-center overflow-hidden bg-gradient-to-b from-black via-gray-900 to-black"
      ...
      <div className="container mx-auto px-4 z-10 flex flex-col lg:flex-row items-center justify-between gap-12">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-8">
            <Button
              className="relative overflow-hidden group hover:bg-primary/90 text-white bg-black dark:text-black dark:bg-white px-6 py-6 h-auto rounded-xl text-lg"
              onClick={() => {
                setLoading(true);
                if (isSignedIn) {
                  router.push("/dashboard");
            ...
            <Button
              variant="outline"
              className="border-gray-700 text-gray-300 hover:text-white hover:bg-gray-800 px-6 py-6 h-auto rounded-xl text-lg"
            >
              Explore Features
            </Button>
          </div>
        ...
        >
          ...
          >
            ...
            <div className="absolute inset-0 rounded-2xl bg-gradient-to-br from-gray-900 to-black p-1">
            ...
            {/* Reflection effect */}
            <div className="absolute inset-0 rounded-2xl bg-gradient-to-b from-transparent to-white/10 pointer-events-none"></div>
          ...
          {/* Feature badges */}
          <div className="absolute -bottom-4 -right-4 bg-gray-900/80 backdrop-blur-md border border-gray-800 rounded-lg px-3 py-2 flex items-center gap-2">
            <Star size={14} className="text-yellow-500" />
            <span className="text-xs text-white">Premium Quality</span>
          </div>

          <div className="absolute -top-4 -left-4 bg-gray-900/80 backdrop-blur-md border border-gray-800 rounded-lg px-3 py-2 flex items-center gap-2">
            <Zap size={14} className="text-primary" />
            <span className="text-xs text-white">Instant Generation</span>
          </div>
        </motion.div>
      </div>

      {/* Bottom wave divider */}
      <div className="absolute bottom-0 left-0 right-0 h-16 bg-[url('/wave-divider.svg')] bg-repeat-x bg-bottom opacity-10"></div>
    </div>
  );
}
